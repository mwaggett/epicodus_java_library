...
COPY books (id, title, patron_id) FROM stdin;
4	Harry Potter and the Chamber of Secrets	\N
5	Harry Potter and the Goblet of Fire	\N
6	Moby Dick	\N
...
COPY checkouts (id, book_id, patron_id) FROM stdin;
\.
